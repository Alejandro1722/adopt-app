...
4. En el folder Adopt-backend, archivo indexController, cambiar la contraseña que se tiene asignada 
en Postgresql. Los demás datos deben dejarse tal cual, al menos que cuente con otras características. 
5. Para ejecutar la aplicación, debe iniciarse tanto el folder Adopt-backend, como Adopt-app con el 
comando npm start.
